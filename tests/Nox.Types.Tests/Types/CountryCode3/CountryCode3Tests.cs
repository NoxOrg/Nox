...
public class CountryCode3Tests
{
    ...
    {
        var countryCode3 = Nox.Types.CountryCode3.From(countryCode3String);
    ...
    {
        var countryCode3_1 = Nox.Types.CountryCode3.From("AFG");

        var countryCode3_2 = Nox.Types.CountryCode3.From("AFG");
    ...
    public void CreatingCountryCode3_DifferentCountryCode3_ReturnsUnEqual()
    {
        ...
        var countryCode3_2 = Nox.Types.CountryCode3.From("ALA");
    ...
    {
        var countryCode3 = Nox.Types.CountryCode3.From("AFG");
