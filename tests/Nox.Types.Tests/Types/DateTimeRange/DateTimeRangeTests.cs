...
public class DateTimeRangeTests
{
    ...
    {
        var start1 = System.DateTime.Parse(startStr1);
        var end1 = System.DateTime.Parse(endStr1);

        var start2 = System.DateTime.Parse(startStr2);
        var end2 = System.DateTime.Parse(endStr2);
    ...
    public void Duration_WithValidStarnAndEnd_ReturnsValue()
    {
        ...
        var end = new System.DateTime(2023, 01, 20);
    ...
    public void Intersect_WithOverlappingRanges_ReturnsIntersectedDateTimeRange(string startStr1, string endStr1, string startStr2, string endStr2, string expectedStartStr, string expectedEndStr)
    {
        ...
        var expectedStart = System.DateTime.Parse(expectedStartStr);
        var expectedEnd = System.DateTime.Parse(expectedEndStr);
    ...
    {
        var start1 = new System.DateTime(2023, 01, 01);
        var end1 = new System.DateTime(2023, 02, 01);

        var start2 = new System.DateTime(2021, 03, 01);
        var end2 = new System.DateTime(2021, 04, 01);
    ...
    public void ToString_WithoutParameters_ReturnsFormattedStringInInvariantCulture(string culture, string expectedResult)
    {
        void Test()
        {
            var start = new System.DateTime(2023, 6, 20, 10, 5, 0);
            var end = new System.DateTime(2023, 8, 20, 10, 5, 0);
