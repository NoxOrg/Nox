...
namespace Nox.Types.Tests.Types.LanguageCode;

public class LanguageCodeTestsDataClass : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        yield return new object[] { "AV" };
        yield return new object[] { "AY" };
        ...
        yield return new object[] { "GV" };
        yield return new object[] { "HA" };
        yield return new object[] { "HE" };
        yield return new object[] { "HI" };
        yield return new object[] { "HO" };
        ...
        yield return new object[] { "IG" };
        yield return new object[] { "II" };
        yield return new object[] { "IK" };
        ...
        yield return new object[] { "LN" };
        yield return new object[] { "LO" };
