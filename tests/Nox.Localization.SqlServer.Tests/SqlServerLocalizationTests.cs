...
public class SqlServerLocalizationTests: IClassFixture<WebApplicationFixture>
{
    ...
    public SqlServerLocalizationTests(WebApplicationFixture fixture)
    {
        _fixture = fixture;
    ...
    public void Localizer_Returns_Default_Value()
    {
        ...
        var localizer = factory.Create(typeof(SqlServerLocalizationTests));
