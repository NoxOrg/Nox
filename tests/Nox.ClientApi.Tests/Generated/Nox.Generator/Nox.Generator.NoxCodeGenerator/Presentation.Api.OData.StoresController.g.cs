...
public partial class StoresController : ODataController
{
    ...
    public async Task<ActionResult> CreateRefToStoreOwner([FromRoute] System.UInt32 key, [FromRoute] System.String relatedKey)
    {
    ...
    public async Task<ActionResult> DeleteRefToStoreOwner([FromRoute] System.UInt32 key)
    {
        if (!ModelState.IsValid)
        {
            return BadRequest(ModelState);
