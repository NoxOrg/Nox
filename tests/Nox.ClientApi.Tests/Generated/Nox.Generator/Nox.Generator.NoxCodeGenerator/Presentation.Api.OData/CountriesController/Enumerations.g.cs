...
public abstract partial class CountriesControllerBase
{
    ...
    public virtual async Task<ActionResult<IQueryable<DtoNameSpace.CountryContinentDto>>> GetCountryContinentsNonConventional()
    {            
    ...
    public virtual async Task<ActionResult<IQueryable<DtoNameSpace.CountryContinentLocalizedDto>>> GetCountryContinentsLanguagesNonConventional()
    {            
