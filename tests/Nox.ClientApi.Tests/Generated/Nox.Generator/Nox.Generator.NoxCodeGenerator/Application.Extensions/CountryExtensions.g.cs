...
internal static class CountryExtensions
{
    public static CountryDto ToDto(this ClientApi.Domain.Country entity)
    {
        ...
        dto.SetIfNotNull(entity?.DebtPerCapita, (dto) => dto.DebtPerCapita =entity!.DebtPerCapita);
        ...
        dto.SetIfNotNull(entity?.ShortDescription, (dto) => dto.ShortDescription =entity!.ShortDescription);
        ...
        dto.SetIfNotNull(entity?.TestAttForLocalization, (dto) => dto.TestAttForLocalization =entity!.TestAttForLocalization!.Value);
