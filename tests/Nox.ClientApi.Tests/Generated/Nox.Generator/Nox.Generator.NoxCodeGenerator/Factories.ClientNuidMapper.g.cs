...
public class ClientNuidMapper: EntityMapperBase<ClientNuid>
{
    ...
    public override void PartialMapToEntity(ClientNuid entity, Entity entityDefinition, Dictionary<string, dynamic> updatedProperties, HashSet<string> deletedPropertyNames)
    {    
