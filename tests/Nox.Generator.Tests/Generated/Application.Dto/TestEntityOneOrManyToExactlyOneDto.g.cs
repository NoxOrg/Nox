...
/// .
/// </summary>
public abstract class TestEntityOneOrManyToExactlyOneDtoBase : EntityDtoBase, IEntityDto<DomainNamespace.TestEntityOneOrManyToExactlyOne>
{
    ...
    public virtual IReadOnlyDictionary<string, IEnumerable<string>> Validate()
    {
        ...
        if (this.TextTestField2 is not null)
            ExecuteActionAndCollectValidationExceptions("TextTestField2", () => DomainNamespace.TestEntityOneOrManyToExactlyOneMetadata.CreateTextTestField2(this.TextTestField2.NonNullValue<System.String>()), result);
        else
