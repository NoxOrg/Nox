...
/// <summary>
/// Static methods for the SecondTestEntityZeroOrMany class.
/// </summary>
public partial class SecondTestEntityZeroOrManyMetadata
{
        ...
        /// <summary>
        /// Type options for property 'TestEntityZeroOrManyId'
        /// </summary>
        public static Nox.Types.TextTypeOptions TestEntityZeroOrManyIdTypeOptions {get; private set;} = new ()
        {
            MinLength = 2,
            MaxLength = 2,
            IsUnicode = false,
        ...
        /// <summary>
        /// Factory for property 'TestEntityZeroOrManyId'
        /// </summary>
        public static Nox.Types.Text CreateTestEntityZeroOrManyId(System.String value)
            => Nox.Types.Text.From(value, TestEntityZeroOrManyIdTypeOptions);
        ...
        public static TypeUserInterface? TextTestField2UiOptions(NoxSolution solution) 
            => solution.Domain!
                .GetEntityByName("SecondTestEntityZeroOrMany")
