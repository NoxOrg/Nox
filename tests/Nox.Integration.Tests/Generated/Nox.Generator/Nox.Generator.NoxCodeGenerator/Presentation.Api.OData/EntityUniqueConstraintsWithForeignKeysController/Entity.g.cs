...
public abstract partial class EntityUniqueConstraintsWithForeignKeysControllerBase : ODataController
{
    ...
    public virtual async Task<ActionResult<EntityUniqueConstraintsWithForeignKeyDto>> Patch([FromRoute] System.Guid key, [FromBody] Delta<EntityUniqueConstraintsWithForeignKeyDto> entityUniqueConstraintsWithForeignKey)
    {
        if (!ModelState.IsValid)
        {
            return BadRequest(ModelState);
