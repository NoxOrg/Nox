...
public abstract partial class TestEntityOwnedRelationshipZeroOrManiesControllerBase : ODataController
{
    ...
    [EnableQuery]
    public virtual async Task<SingleResult<TestEntityOwnedRelationshipZeroOrManyDto>> Get([FromRoute] System.String key)
    {
    ...
    public virtual async Task<ActionResult<TestEntityOwnedRelationshipZeroOrManyDto>> Patch([FromRoute] System.String key, [FromBody] Delta<TestEntityOwnedRelationshipZeroOrManyPartialUpdateDto> testEntityOwnedRelationshipZeroOrMany)
    {
        ...
        var updatedProperties = Nox.Presentation.Api.OData.ODataApi.GetDeltaUpdatedProperties<TestEntityOwnedRelationshipZeroOrManyPartialUpdateDto>(testEntityOwnedRelationshipZeroOrMany);
