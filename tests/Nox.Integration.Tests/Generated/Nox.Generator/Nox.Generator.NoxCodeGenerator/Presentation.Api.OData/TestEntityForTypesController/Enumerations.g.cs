...
public abstract partial class TestEntityForTypesControllerBase
{
    ...
    public virtual async Task<ActionResult<IQueryable<DtoNameSpace.TestEntityForTypesEnumerationTestFieldDto>>> GetTestEntityForTypesEnumerationTestFieldsNonConventional()
    {            
    ...
    public virtual async Task<ActionResult<IQueryable<DtoNameSpace.TestEntityForTypesEnumerationTestFieldLocalizedDto>>> GetTestEntityForTypesEnumerationTestFieldsLanguagesNonConventional()
    {            
