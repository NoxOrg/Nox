...
public abstract partial class TestEntityForTypesControllerBase : ODataController
{
    ...
    [EnableQuery]
    public virtual async Task<SingleResult<TestEntityForTypesDto>> Get([FromRoute] System.String key)
    {
    ...
    public virtual async Task<ActionResult<TestEntityForTypesDto>> Patch([FromRoute] System.String key, [FromBody] Delta<TestEntityForTypesPartialUpdateDto> testEntityForTypes)
    {
        ...
        var updatedProperties = Nox.Presentation.Api.OData.ODataApi.GetDeltaUpdatedProperties<TestEntityForTypesPartialUpdateDto>(testEntityForTypes);
