...
public abstract partial class EntityUniqueConstraintsRelatedForeignKeysControllerBase : ODataController
{
    ...
    public virtual async Task<ActionResult<EntityUniqueConstraintsRelatedForeignKeyDto>> Patch([FromRoute] System.Int32 key, [FromBody] Delta<EntityUniqueConstraintsRelatedForeignKeyDto> entityUniqueConstraintsRelatedForeignKey)
    {
        if (!ModelState.IsValid)
        {
            return BadRequest(ModelState);
