...
public abstract partial class TestEntityOwnedRelationshipZeroOrOnesControllerBase : ODataController
{
    ...
    [EnableQuery]
    public virtual async Task<SingleResult<TestEntityOwnedRelationshipZeroOrOneDto>> Get([FromRoute] System.String key)
    {
    ...
    public virtual async Task<ActionResult<TestEntityOwnedRelationshipZeroOrOneDto>> Patch([FromRoute] System.String key, [FromBody] Delta<TestEntityOwnedRelationshipZeroOrOnePartialUpdateDto> testEntityOwnedRelationshipZeroOrOne)
    {
        if(testEntityOwnedRelationshipZeroOrOne is null)
        {
            throw new Nox.Exceptions.BadRequestInvalidFieldException();
        ...
        var updatedProperties = Nox.Presentation.Api.OData.ODataApi.GetDeltaUpdatedProperties<TestEntityOwnedRelationshipZeroOrOnePartialUpdateDto>(testEntityOwnedRelationshipZeroOrOne);
    ...
    {
        var etag = Request.GetDecodedEtagHeader();
        var result = await _mediator.Send(new DeleteTestEntityOwnedRelationshipZeroOrOneByIdCommand(new List<TestEntityOwnedRelationshipZeroOrOneKeyDto> { new TestEntityOwnedRelationshipZeroOrOneKeyDto(key) }, etag));
