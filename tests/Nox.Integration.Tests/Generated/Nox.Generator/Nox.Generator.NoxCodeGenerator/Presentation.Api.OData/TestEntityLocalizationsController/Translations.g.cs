...
public abstract partial class TestEntityLocalizationsControllerBase
{
    ...
    // [HttpPost("api/TestEntityLocalizations/{key}/TestEntityLocalizationLocalized/")]
    // public virtual async Task<ActionResult<TestEntityLocalizationLocalizedDto>> CreateTestEntityLocalizationLocalized( , [FromBody] TestEntityLocalizationLocalizedDto testEntityLocalizationLocalizedDto)
    // {
    //     var result = await _mediator.Send(new ApplicationCommandsNameSpace.CreateTestEntityLocalizationLocalizedCommand(testEntityLocalizationLocalizedDto));
    //     return Ok(result);
    // }
