...
public abstract class SecondTestEntityTwoRelationshipsManyToManyDtoBase : EntityDtoBase
{
    ...
    public virtual IReadOnlyDictionary<string, IEnumerable<string>> Validate()
    {
        ...
        if (this.TextTestField2 is not null)
            CollectValidationExceptions("TextTestField2", () => SecondTestEntityTwoRelationshipsManyToManyMetadata.CreateTextTestField2(this.TextTestField2.NonNullValue<System.String>()), result);
        else
