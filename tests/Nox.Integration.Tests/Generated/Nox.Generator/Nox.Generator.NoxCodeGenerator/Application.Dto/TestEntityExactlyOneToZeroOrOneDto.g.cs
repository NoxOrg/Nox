...
/// .
/// </summary>
public abstract class TestEntityExactlyOneToZeroOrOneDtoBase : EntityDtoBase
{
    #region Validation
    public virtual IReadOnlyDictionary<string, IEnumerable<string>> Validate()
    {
        ...
        if (this.TextTestField2 is not null)
            CollectValidationExceptions("TextTestField2", () => TestEntityExactlyOneToZeroOrOneMetadata.CreateTextTestField2(this.TextTestField2.NonNullValue<System.String>()), result);
        else
