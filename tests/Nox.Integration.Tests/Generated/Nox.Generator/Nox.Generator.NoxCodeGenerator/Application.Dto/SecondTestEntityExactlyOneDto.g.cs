...
/// .
/// </summary>
public abstract class SecondTestEntityExactlyOneDtoBase : EntityDtoBase, IEntityDto<DomainNamespace.SecondTestEntityExactlyOne>
{
    ...
    public virtual IReadOnlyDictionary<string, IEnumerable<string>> Validate()
    {
        ...
        if (this.TextTestField2 is not null)
            ExecuteActionAndCollectValidationExceptions("TextTestField2", () => DomainNamespace.SecondTestEntityExactlyOneMetadata.CreateTextTestField2(this.TextTestField2.NonNullValue<System.String>()), result);
        else
