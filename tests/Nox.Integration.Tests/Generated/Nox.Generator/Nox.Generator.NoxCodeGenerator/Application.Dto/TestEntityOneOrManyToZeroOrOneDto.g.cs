...
/// .
/// </summary>
public abstract class TestEntityOneOrManyToZeroOrOneDtoBase : EntityDtoBase, IEntityDto<TestEntityOneOrManyToZeroOrOneEntity>
{
    ...
    public virtual IReadOnlyDictionary<string, IEnumerable<string>> Validate()
    {
        ...
        if (this.TextTestField2 is not null)
            ExecuteActionAndCollectValidationExceptions("TextTestField2", () => TestWebApp.Domain.TestEntityOneOrManyToZeroOrOneMetadata.CreateTextTestField2(this.TextTestField2.NonNullValue<System.String>()), result);
        else
