...
/// <summary>
/// Update TestEntityZeroOrManyToExactlyOne
/// .
/// </summary>
...
public abstract class TestEntityZeroOrManyToExactlyOneDtoBase : EntityDtoBase
{
    ...
    public virtual IReadOnlyDictionary<string, IEnumerable<string>> Validate()
    {
        ...
        if (this.TextTestField2 is not null)
            CollectValidationExceptions("TextTestField2", () => TestEntityZeroOrManyToExactlyOneMetadata.CreateTextTestField2(this.TextTestField2.NonNullValue<System.String>()), result);
        else
