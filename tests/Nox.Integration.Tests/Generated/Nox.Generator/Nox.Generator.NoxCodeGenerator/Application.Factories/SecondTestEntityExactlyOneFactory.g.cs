...
internal abstract class SecondTestEntityExactlyOneFactoryBase : IEntityFactory<SecondTestEntityExactlyOneEntity, SecondTestEntityExactlyOneCreateDto, SecondTestEntityExactlyOneUpdateDto>
{
    ...
    public virtual async Task<SecondTestEntityExactlyOneEntity> CreateEntityAsync(SecondTestEntityExactlyOneCreateDto createDto, Nox.Types.CultureCode cultureCode)
    {
        try
        {
        ...
        {
            throw new CreateUpdateEntityInvalidDataException(ex, nameof(SecondTestEntityExactlyOneEntity));
        }        
    }
    ...
    public virtual async Task PartialUpdateEntityAsync(SecondTestEntityExactlyOneEntity entity, Dictionary<string, dynamic> updatedProperties, Nox.Types.CultureCode cultureCode)
    {
        try
        {
    ...
    private async Task<TestWebApp.Domain.SecondTestEntityExactlyOne> ToEntityAsync(SecondTestEntityExactlyOneCreateDto createDto, Nox.Types.CultureCode cultureCode)
    {
        ExceptionCollector<NoxTypeValidationException> exceptionCollector = new();
        var entity = new TestWebApp.Domain.SecondTestEntityExactlyOne();
        exceptionCollector.Collect("Id",() => entity.Id = Dto.SecondTestEntityExactlyOneMetadata.CreateId(createDto.Id.NonNullValue<System.String>()));
        exceptionCollector.Collect("TextTestField2", () => entity.SetIfNotNull(createDto.TextTestField2, (entity) => entity.TextTestField2 = 
            Dto.SecondTestEntityExactlyOneMetadata.CreateTextTestField2(createDto.TextTestField2.NonNullValue<System.String>())));
    ...
    {
        ExceptionCollector<NoxTypeValidationException> exceptionCollector = new();
        exceptionCollector.Collect("TextTestField2",() => entity.TextTestField2 = Dto.SecondTestEntityExactlyOneMetadata.CreateTextTestField2(updateDto.TextTestField2.NonNullValue<System.String>()));
    ...
    private void PartialUpdateEntityInternal(SecondTestEntityExactlyOneEntity entity, Dictionary<string, dynamic> updatedProperties, Nox.Types.CultureCode cultureCode)
    {
        ...
        if (updatedProperties.TryGetValue("TextTestField2", out var TextTestField2UpdateValue))
        {
            ...
            {
                exceptionCollector.Collect("TextTestField2",() =>entity.TextTestField2 = Dto.SecondTestEntityExactlyOneMetadata.CreateTextTestField2(TextTestField2UpdateValue));
            }
        }
        CreateUpdateEntityInvalidDataException.ThrowIfAnyNoxTypeValidationException(exceptionCollector.ValidationErrors);
    }
