...
internal abstract partial class SecondTestEntityOneOrManyBase : AuditableEntityBase, IEntityConcurrent
{
    ...
    public virtual void UpdateAllRefToTestEntityOneOrManyRelationship(List<TestEntityOneOrMany> relatedTestEntityOneOrMany)
    {
        ...
        TestEntityOneOrManyRelationship.AddRange(relatedTestEntityOneOrMany);
    }
