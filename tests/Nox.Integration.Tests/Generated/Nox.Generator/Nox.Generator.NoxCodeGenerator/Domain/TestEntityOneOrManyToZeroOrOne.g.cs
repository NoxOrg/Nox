...
internal abstract partial class TestEntityOneOrManyToZeroOrOneBase : AuditableEntityBase, IEntityConcurrent
{
    ...
    public virtual void UpdateAllRefToTestEntityZeroOrOneToOneOrMany(List<TestEntityZeroOrOneToOneOrMany> relatedTestEntityZeroOrOneToOneOrMany)
    {
        ...
        TestEntityZeroOrOneToOneOrMany.AddRange(relatedTestEntityZeroOrOneToOneOrMany);
    }
