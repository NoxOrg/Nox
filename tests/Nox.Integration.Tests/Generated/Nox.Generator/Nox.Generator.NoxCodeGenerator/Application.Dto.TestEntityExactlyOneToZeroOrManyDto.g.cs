...
/// </summary>
public abstract class TestEntityExactlyOneToZeroOrManyDtoBase : EntityDtoBase, IEntityDto<TestEntityExactlyOneToZeroOrManyEntity>
{
    ...
    public virtual IReadOnlyDictionary<string, IEnumerable<string>> Validate()
    {
        ...
        if (this.TextTestField is not null)
            ExecuteActionAndCollectValidationExceptions("TextTestField", () => TestWebApp.Domain.TestEntityExactlyOneToZeroOrManyMetadata.CreateTextTestField(this.TextTestField.NonNullValue<System.String>()), result);
        else
