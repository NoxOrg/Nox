...
/// .
/// </summary>
public abstract class SecondTestEntityZeroOrOneDtoBase : EntityDtoBase, IEntityDto<SecondTestEntityZeroOrOneEntity>
{
    ...
    public virtual IReadOnlyDictionary<string, IEnumerable<string>> Validate()
    {
        ...
        if (this.TextTestField2 is not null)
            ExecuteActionAndCollectValidationExceptions("TextTestField2", () => TestWebApp.Domain.SecondTestEntityZeroOrOneMetadata.CreateTextTestField2(this.TextTestField2.NonNullValue<System.String>()), result);
        else
    ...
    /// </summary>
    public virtual TestEntityZeroOrOneDto? TestEntityZeroOrOneRelationship { get; set; } = null!;
