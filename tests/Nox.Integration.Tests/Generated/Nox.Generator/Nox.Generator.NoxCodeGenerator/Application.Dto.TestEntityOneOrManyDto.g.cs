...
/// </summary>
public abstract class TestEntityOneOrManyDtoBase : EntityDtoBase, IEntityDto<TestEntityOneOrMany>
{
    ...
    /// </summary>
    public virtual List<SecondTestEntityOneOrManyDto> SecondTestEntityOneOrManyRelationship { get; set; } = new();
