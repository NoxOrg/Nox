...
/// <summary>
/// Static methods for the SecondTestEntityOneOrMany class.
/// </summary>
public partial class SecondTestEntityOneOrManyMetadata
{
        ...
        /// <summary>
        /// Type options for property 'TestEntityOneOrManyId'
        /// </summary>
        public static Nox.Types.TextTypeOptions TestEntityOneOrManyIdTypeOptions {get; private set;} = new ()
        {
            MinLength = 2,
            MaxLength = 2,
            IsUnicode = false,
        ...
        /// <summary>
        /// Factory for property 'TestEntityOneOrManyId'
        /// </summary>
        public static Nox.Types.Text CreateTestEntityOneOrManyId(System.String value)
            => Nox.Types.Text.From(value, TestEntityOneOrManyIdTypeOptions);
        ...
        public static TypeUserInterface? TextTestField2UiOptions(NoxSolution solution) 
            => solution.Domain!
                .GetEntityByName("SecondTestEntityOneOrMany")
