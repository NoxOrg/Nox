...
internal partial class CreateTestEntityOneOrManyToZeroOrManyCommandHandler: CreateTestEntityOneOrManyToZeroOrManyCommandHandlerBase
{
	public CreateTestEntityOneOrManyToZeroOrManyCommandHandler(
		...
		IEntityFactory<TestEntityZeroOrManyToOneOrMany, TestEntityZeroOrManyToOneOrManyCreateDto, TestEntityZeroOrManyToOneOrManyUpdateDto> testentityzeroormanytooneormanyfactory,
		IEntityFactory<TestEntityOneOrManyToZeroOrMany, TestEntityOneOrManyToZeroOrManyCreateDto, TestEntityOneOrManyToZeroOrManyUpdateDto> entityFactory,
		IServiceProvider serviceProvider)
		: base(dbContext, noxSolution,testentityzeroormanytooneormanyfactory, entityFactory, serviceProvider)
	{
	}
}


internal abstract class CreateTestEntityOneOrManyToZeroOrManyCommandHandlerBase: CommandBase<CreateTestEntityOneOrManyToZeroOrManyCommand,TestEntityOneOrManyToZeroOrMany>, IRequestHandler <CreateTestEntityOneOrManyToZeroOrManyCommand, TestEntityOneOrManyToZeroOrManyKeyDto>
{
	...
	private readonly IEntityFactory<TestEntityZeroOrManyToOneOrMany, TestEntityZeroOrManyToOneOrManyCreateDto, TestEntityZeroOrManyToOneOrManyUpdateDto> _testentityzeroormanytooneormanyfactory;
