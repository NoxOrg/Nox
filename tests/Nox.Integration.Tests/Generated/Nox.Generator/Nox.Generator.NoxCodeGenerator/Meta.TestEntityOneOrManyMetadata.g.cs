...
/// <summary>
/// Static methods for the TestEntityOneOrMany class.
/// </summary>
public partial class TestEntityOneOrManyMetadata
{
...
>>>>>>> main
        ...
        /// <summary>
        /// Type options for property 'SecondTestEntityOneOrManyId'
        /// </summary>
        public static Nox.Types.TextTypeOptions SecondTestEntityOneOrManyIdTypeOptions {get; private set;} = new ()
        {
            MinLength = 2,
            MaxLength = 2,
            IsUnicode = false,
...
>>>>>>> main
        ...
        /// <summary>
        /// Factory for property 'SecondTestEntityOneOrManyId'
        /// </summary>
        public static Nox.Types.Text CreateSecondTestEntityOneOrManyId(System.String value)
            => Nox.Types.Text.From(value, SecondTestEntityOneOrManyIdTypeOptions);
        ...
        public static TypeUserInterface? TextTestFieldUiOptions(NoxSolution solution) 
            => solution.Domain!
                .GetEntityByName("TestEntityOneOrMany")
