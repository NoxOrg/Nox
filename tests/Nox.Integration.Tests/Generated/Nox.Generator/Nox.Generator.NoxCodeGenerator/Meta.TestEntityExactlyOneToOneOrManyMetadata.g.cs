...
/// <summary>
/// Static methods for the TestEntityExactlyOneToOneOrMany class.
/// </summary>
public partial class TestEntityExactlyOneToOneOrManyMetadata
{
        ...
        /// <summary>
        /// Type options for property 'TestEntityOneOrManyToExactlyOneId'
        /// </summary>
        public static Nox.Types.TextTypeOptions TestEntityOneOrManyToExactlyOneIdTypeOptions {get; private set;} = new ()
        {
            MinLength = 2,
            MaxLength = 2,
            IsUnicode = false,
        ...
        /// <summary>
        /// Factory for property 'TestEntityOneOrManyToExactlyOneId'
        /// </summary>
        public static Nox.Types.Text CreateTestEntityOneOrManyToExactlyOneId(System.String value)
            => Nox.Types.Text.From(value, TestEntityOneOrManyToExactlyOneIdTypeOptions);
        ...
        public static TypeUserInterface? TextTestFieldUiOptions(NoxSolution solution) 
            => solution.Domain!
                .GetEntityByName("TestEntityExactlyOneToOneOrMany")
