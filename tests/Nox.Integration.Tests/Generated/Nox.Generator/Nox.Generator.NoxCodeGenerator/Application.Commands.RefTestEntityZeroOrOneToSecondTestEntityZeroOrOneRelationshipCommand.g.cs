...
public record CreateRefTestEntityZeroOrOneToSecondTestEntityZeroOrOneRelationshipCommand(TestEntityZeroOrOneKeyDto EntityKeyDto, SecondTestEntityZeroOrOneKeyDto RelatedEntityKeyDto)
...
internal abstract class RefTestEntityZeroOrOneToSecondTestEntityZeroOrOneRelationshipCommandHandlerBase<TRequest> : CommandBase<TRequest, TestEntityZeroOrOne>,
	IRequestHandler <TRequest, bool> where TRequest : RefTestEntityZeroOrOneToSecondTestEntityZeroOrOneRelationshipCommand
{
	...
	public virtual async Task<bool> Handle(TRequest request, CancellationToken cancellationToken)
	{
		...
		OnExecuting(request);
		var keyId = CreateNoxTypeForKey<TestEntityZeroOrOne, Nox.Types.Text>("Id", request.EntityKeyDto.keyId);
		...
		SecondTestEntityZeroOrOne? relatedEntity = null!;
		if(request.RelatedEntityKeyDto is not null)
		{
			var relatedKeyId = CreateNoxTypeForKey<SecondTestEntityZeroOrOne, Nox.Types.Text>("Id", request.RelatedEntityKeyDto.keyId);
