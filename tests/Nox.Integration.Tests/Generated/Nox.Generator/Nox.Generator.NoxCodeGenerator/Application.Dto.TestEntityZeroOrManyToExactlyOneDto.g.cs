...
/// .
/// </summary>
public abstract class TestEntityZeroOrManyToExactlyOneDtoBase : EntityDtoBase, IEntityDto<TestEntityZeroOrManyToExactlyOneEntity>
{
    ...
    public virtual IReadOnlyDictionary<string, IEnumerable<string>> Validate()
    {
        ...
        if (this.TextTestField2 is not null)
            ExecuteActionAndCollectValidationExceptions("TextTestField2", () => TestWebApp.Domain.TestEntityZeroOrManyToExactlyOneMetadata.CreateTextTestField2(this.TextTestField2.NonNullValue<System.String>()), result);
        else
    ...
    /// </summary>
    public virtual List<TestEntityExactlyOneToZeroOrManyDto> TestEntityExactlyOneToZeroOrMany { get; set; } = new();
