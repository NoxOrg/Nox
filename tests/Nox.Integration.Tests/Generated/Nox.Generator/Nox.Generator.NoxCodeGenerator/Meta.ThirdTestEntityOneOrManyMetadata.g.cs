...
/// <summary>
/// Static methods for the ThirdTestEntityOneOrMany class.
/// </summary>
public partial class ThirdTestEntityOneOrManyMetadata
{
        ...
        /// <summary>
        /// Type options for property 'ThirdTestEntityZeroOrManyId'
        /// </summary>
        public static Nox.Types.TextTypeOptions ThirdTestEntityZeroOrManyIdTypeOptions {get; private set;} = new ()
        {
            MinLength = 2,
            MaxLength = 2,
            IsUnicode = false,
        ...
        /// <summary>
        /// Factory for property 'ThirdTestEntityZeroOrManyId'
        /// </summary>
