...
internal abstract class UpdateEntityUniqueConstraintsWithForeignKeyCommandHandlerBase : CommandBase<UpdateEntityUniqueConstraintsWithForeignKeyCommand, EntityUniqueConstraintsWithForeignKeyEntity>, IRequestHandler<UpdateEntityUniqueConstraintsWithForeignKeyCommand, EntityUniqueConstraintsWithForeignKeyKeyDto?>
{
	...
	public UpdateEntityUniqueConstraintsWithForeignKeyCommandHandlerBase(
        AppDbContext dbContext,
		NoxSolution noxSolution,
		IEntityFactory<EntityUniqueConstraintsWithForeignKeyEntity, EntityUniqueConstraintsWithForeignKeyCreateDto, EntityUniqueConstraintsWithForeignKeyUpdateDto> entityFactory)
		: base(noxSolution)
	...
	public virtual async Task<EntityUniqueConstraintsWithForeignKeyKeyDto?> Handle(UpdateEntityUniqueConstraintsWithForeignKeyCommand request, CancellationToken cancellationToken)
	{
		...
		var entityUniqueConstraintsRelatedForeignKeyKey = TestWebApp.Domain.EntityUniqueConstraintsRelatedForeignKeyMetadata.CreateId(request.EntityDto.EntityUniqueConstraintsRelatedForeignKeyId);
		var entityUniqueConstraintsRelatedForeignKeyEntity = await DbContext.EntityUniqueConstraintsRelatedForeignKeys.FindAsync(entityUniqueConstraintsRelatedForeignKeyKey);
						
		if(entityUniqueConstraintsRelatedForeignKeyEntity is not null)
			entity.CreateRefToEntityUniqueConstraintsRelatedForeignKey(entityUniqueConstraintsRelatedForeignKeyEntity);
		else
			throw new RelatedEntityNotFoundException("EntityUniqueConstraintsRelatedForeignKey", request.EntityDto.EntityUniqueConstraintsRelatedForeignKeyId.ToString());
