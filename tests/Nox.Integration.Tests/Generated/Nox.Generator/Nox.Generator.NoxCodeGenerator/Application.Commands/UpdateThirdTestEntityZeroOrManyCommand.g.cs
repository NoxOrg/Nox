...
public partial record UpdateThirdTestEntityZeroOrManyCommand(System.String keyId, ThirdTestEntityZeroOrManyUpdateDto EntityDto, System.Guid? Etag) : IRequest<ThirdTestEntityZeroOrManyKeyDto?>;
...
internal abstract class UpdateThirdTestEntityZeroOrManyCommandHandlerBase : CommandBase<UpdateThirdTestEntityZeroOrManyCommand, ThirdTestEntityZeroOrManyEntity>, IRequestHandler<UpdateThirdTestEntityZeroOrManyCommand, ThirdTestEntityZeroOrManyKeyDto?>
{
	...
	public virtual async Task<ThirdTestEntityZeroOrManyKeyDto?> Handle(UpdateThirdTestEntityZeroOrManyCommand request, CancellationToken cancellationToken)
	{
		...
		var thirdTestEntityOneOrManyRelationshipEntities = new List<ThirdTestEntityOneOrMany>();
		foreach(var relatedEntityId in request.EntityDto.ThirdTestEntityOneOrManyRelationshipId)
		{
			...
			if(relatedEntity is not null)
				thirdTestEntityOneOrManyRelationshipEntities.Add(relatedEntity);
			else
				throw new RelatedEntityNotFoundException("ThirdTestEntityOneOrManyRelationship", relatedEntityId.ToString());
		}
		entity.UpdateRefToThirdTestEntityOneOrManyRelationship(thirdTestEntityOneOrManyRelationshipEntities);
