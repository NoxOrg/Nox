...
public partial class CreateRefTransactionToTransactionForCustomerCommandHandler: CommandBase<CreateRefTransactionToTransactionForCustomerCommand, Transaction>, 
	IRequestHandler <CreateRefTransactionToTransactionForCustomerCommand, bool>
{
	...
	public async Task<bool> Handle(CreateRefTransactionToTransactionForCustomerCommand request, CancellationToken cancellationToken)
	{
		OnExecuting(request);
