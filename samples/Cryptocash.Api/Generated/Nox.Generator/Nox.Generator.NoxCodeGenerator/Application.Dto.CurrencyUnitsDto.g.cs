...
public partial class CurrencyUnitsDto
{
    ...
    public CurrencyUnits ToEntity()
    {
        var entity = new CurrencyUnits();
        entity.Id = CurrencyUnits.CreateId(Id);
        entity.MajorName = CurrencyUnits.CreateMajorName(MajorName);
        entity.MajorSymbol = CurrencyUnits.CreateMajorSymbol(MajorSymbol);
        entity.MinorName = CurrencyUnits.CreateMinorName(MinorName);
        entity.MinorSymbol = CurrencyUnits.CreateMinorSymbol(MinorSymbol);
        entity.MinorToMajorValue = CurrencyUnits.CreateMinorToMajorValue(MinorToMajorValue);
