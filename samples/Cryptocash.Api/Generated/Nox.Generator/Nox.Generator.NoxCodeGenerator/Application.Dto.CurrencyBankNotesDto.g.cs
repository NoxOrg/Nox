...
public partial class CurrencyBankNotesDto
{
    ...
    public CurrencyBankNotes ToEntity()
    {
        var entity = new CurrencyBankNotes();
        entity.Id = CurrencyBankNotes.CreateId(Id);
        entity.BankNote = CurrencyBankNotes.CreateBankNote(BankNote);
        entity.IsRare = CurrencyBankNotes.CreateIsRare(IsRare);
