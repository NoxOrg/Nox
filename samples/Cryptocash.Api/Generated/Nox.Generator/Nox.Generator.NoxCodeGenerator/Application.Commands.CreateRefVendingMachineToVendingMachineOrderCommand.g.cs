	...
	IRequestHandler <CreateRefVendingMachineToVendingMachineOrderCommand, bool>
{
	...
	public async Task<bool> Handle(CreateRefVendingMachineToVendingMachineOrderCommand request, CancellationToken cancellationToken)
	{
		OnExecuting(request);
		...
		entity.VendingMachineOrders.Add(relatedEntity);
