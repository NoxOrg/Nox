...
internal static class ODataServiceCollectionExtensions
{
    ...
    public static void AddNoxOdata(this IServiceCollection services, Action<ODataModelBuilder>? configure)
    {
        ...
        builder.ComplexType<CountryProcToTablePartialUpdateDto>();
        ...
        builder.EntitySet<CountryProcToTableDto>("CountryProcToTables");
		builder.EntityType<CountryProcToTableDto>().HasKey(e => new { e.CountryId });
