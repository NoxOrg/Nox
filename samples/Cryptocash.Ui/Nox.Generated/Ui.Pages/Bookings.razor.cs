...
#region ADD
    ...
    private async Task AddBookingSubmit()
    {
        showAddDialog = false;        
        await Search();
    }
...
#region EDIT
    ...
    [Parameter]
    public BookingModel? SelectedEntity { get; set; }   

    private void ShowEditDialog(BookingModel? currentSelected)
    {
    ...
    private async Task EditBookingSubmit()
    {
        showEditDialog = false;    
        SelectedEntity = null;
        await Search();        
...
#region DELETE
    ...
    [Parameter]
    public BookingModel? DeleteEntity { get; set; }   
    ...
    private void ShowDeleteConfirmation(BookingModel? currentSelected)
    {
    ...
    private async Task DeleteBookingSubmit()
    {
        try
        {
            ...
            {
                await BookingsService.DeleteAsync(DeleteEntity);
            }
            else
            {
                HasDeleteError = true;
