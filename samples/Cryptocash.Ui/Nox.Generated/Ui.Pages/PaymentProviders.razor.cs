...
public partial class PaymentProviders : ComponentBase
{
    ...
    {
        CurrentApiUiService = PaymentProvidersService.IntialiseApiUiService();
    }
...
#region EDIT
    ...
    [Parameter]
    public PaymentProviderModel? SelectedEntity { get; set; }   

    private void ShowEditDialog(PaymentProviderModel? currentSelected)
    {
...
#region DELETE
    ...
    [Parameter]
    public PaymentProviderModel? DeleteEntity { get; set; }   
    ...
    private void ShowDeleteConfirmation(PaymentProviderModel? currentSelected)
    {
    ...
    private async Task DeletePaymentProviderSubmit()
    {
        try
        {
            ...
            {
                await PaymentProvidersService.DeleteAsync(DeleteEntity);
            }
            else
            {
                HasDeleteError = true;
