...
#region ADD
    ...
    private async Task AddPaymentDetailSubmit()
    {
        showAddDialog = false;        
        await Search();
    }
...
#region EDIT
    ...
    [Parameter]
    public PaymentDetailModel? SelectedEntity { get; set; }   

    private void ShowEditDialog(PaymentDetailModel? currentSelected)
    {
    ...
    private async Task EditPaymentDetailSubmit()
    {
        showEditDialog = false;    
        SelectedEntity = null;
        await Search();        
...
#region DELETE
    ...
    [Parameter]
    public PaymentDetailModel? DeleteEntity { get; set; }   
    ...
    private void ShowDeleteConfirmation(PaymentDetailModel? currentSelected)
    {
    ...
    private async Task DeletePaymentDetailSubmit()
    {
        try
        {
            ...
            {
                await PaymentDetailsService.DeleteAsync(DeleteEntity);
            }
            else
            {
                HasDeleteError = true;
