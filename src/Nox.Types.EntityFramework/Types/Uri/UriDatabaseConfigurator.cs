...
/// <summary>
/// Configurator for the <see cref="Uri"/>  Nox type in the database.
/// This class implements the INoxTypeDatabaseConfigurator interface to provide configuration details for the Uri Nox type in the database.
/// </summary>
public class UriDatabaseConfigurator : INoxTypeDatabaseConfigurator
{
    /// <summary>
    /// Gets the NoxType associated with this configurator, which is Uri.
    /// </summary>
    public NoxType ForNoxType => NoxType.Uri;

    /// <summary>
    /// Gets a value indicating whether this configurator is the default one for the associated Nox type.
    /// In this case, it is set to true, indicating that this is the default configurator for Uri.
    /// </summary>
    public bool IsDefault => true;

    /// <summary>
    /// Configures the database entity property for the Uri type.
    ...
    /// <summary>
    /// Gets the name of the key property for the Uri type.
