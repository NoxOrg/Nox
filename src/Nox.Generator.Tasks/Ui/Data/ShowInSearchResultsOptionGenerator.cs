...
internal class ShowInSearchResultsOptionGenerator : INoxFileGenerator
{
      ...
      )
    {
        ...
        var templateName = @"Tasks.Ui.Data.ShowInSearchResultsOption";

        new TaskTemplateFileBuilder(codeGeneratorState, absoluteOutputPath)
            .WithClassName($"ShowInSearchResultsOption")
