...
public enum NoxType : uint
{
    ...
    [CompoundType]
    [CompoundComponent("Start", typeof(DateTime))]
    [CompoundComponent("End", typeof(DateTime))]
    ...
    [CompoundComponent("SizeInBytes", typeof(uint))]
    File = 612041382,
    ...
    [CompoundType]
    [CompoundComponent("Latitude",typeof(decimal))]
    [CompoundComponent("Longitude",typeof(decimal))]
    LatLong = 4061881939,
