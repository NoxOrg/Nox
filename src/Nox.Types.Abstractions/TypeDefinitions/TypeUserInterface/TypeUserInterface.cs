...
public class TypeUserInterface
{
    ...
    public string? HelpHint { get; set; } // Will default to attribute description
    ...
    public ShowInSearchResultsOption ShowInSearchResults { get; set; } = ShowInSearchResultsOption.OptionalAndOnByDefault;
    ...
    public bool ShowOnCreateForm { get; set; } = true;
    ...
    public bool ShowOnUpdateForm { get; set; } = true;
