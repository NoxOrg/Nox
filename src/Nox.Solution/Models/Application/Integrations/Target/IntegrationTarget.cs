...
public class IntegrationTarget
{
    ...
    [AdditionalProperties(false)]
    [IfEquals(nameof(IntegrationTargetAdapterType), IntegrationTargetAdapterType.WebApi)]
    public IntegrationTargetWebApiOptions? WebApiOptions { get; set; }

    [AdditionalProperties(false)]
    [IfEquals(nameof(IntegrationTargetAdapterType), IntegrationTargetAdapterType.MessageQueue)]
    public IntegrationTargetMessageQueueOptions? MessageQueueOptions { get; set; }

    [AdditionalProperties(false)]
    [IfEquals(nameof(IntegrationTargetAdapterType), IntegrationTargetAdapterType.NoxEntity)]
