...
[Description("This section specified attributes related to an integration target of type Message Broker. Attributes include the name of the target queue or topic.")]
[AdditionalProperties(false)]
public class IntegrationTargetMessageBrokerOptions
{
    [Required]
