...
internal partial class AppDbContext : Nox.Infrastructure.Persistence.EntityDbContextBase
{
    ...
    public virtual DbSet<ClientApi.Domain.WorkplaceLocalized> WorkplacesLocalized { get; set; } = null!;public virtual DbSet<ClientApi.Domain.TenantBrandLocalized> TenantBrandsLocalized { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        foreach (var entity in _noxSolution.Domain!.Entities)
        {
            ...
            ((INoxDatabaseConfigurator)_dbProvider).ConfigureEntity(modelBuilder, new EntityBuilderAdapter(modelBuilder.Entity(type!).ToTable(entity.Persistence.TableName)), entity);
