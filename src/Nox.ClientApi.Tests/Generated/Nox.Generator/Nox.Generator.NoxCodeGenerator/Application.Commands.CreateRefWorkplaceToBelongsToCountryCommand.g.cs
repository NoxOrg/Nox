...
public partial class CreateRefWorkplaceToBelongsToCountryCommandHandler: CommandBase<CreateRefWorkplaceToBelongsToCountryCommand, Workplace>, 
	IRequestHandler <CreateRefWorkplaceToBelongsToCountryCommand, bool>
{
	...
	public async Task<bool> Handle(CreateRefWorkplaceToBelongsToCountryCommand request, CancellationToken cancellationToken)
	{
		OnExecuting(request);
