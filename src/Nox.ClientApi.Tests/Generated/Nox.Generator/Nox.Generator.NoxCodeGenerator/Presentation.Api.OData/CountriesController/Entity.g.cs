...
public abstract partial class CountriesControllerBase : ODataController
{
    ...
    [EnableQuery]
    public virtual async Task<SingleResult<CountryDto>> Get([FromRoute] System.Int64 key)
    {
    ...
    public virtual async Task<ActionResult<CountryDto>> Patch([FromRoute] System.Int64 key, [FromBody] Delta<CountryPartialUpdateDto> country)
    {
        if(country is null)
        {
            throw new Nox.Exceptions.BadRequestInvalidFieldException();
