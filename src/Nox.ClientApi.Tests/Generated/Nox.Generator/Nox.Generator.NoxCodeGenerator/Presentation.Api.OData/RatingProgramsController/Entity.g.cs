...
public abstract partial class RatingProgramsControllerBase : ODataController
{
    ...
    protected RatingProgramsControllerBase(
        IMediator mediator,
    ...
    public virtual async Task<ActionResult<RatingProgramDto>> Patch([FromRoute] System.Guid keyStoreId, [FromRoute] System.Int64 keyId, [FromBody] Delta<RatingProgramDto> ratingProgram)
    {
        ...
        var etag = Request.GetDecodedEtagHeader();
        var updatedKey = await _mediator.Send(new PartialUpdateRatingProgramCommand(keyStoreId, keyId, updatedProperties, etag));
...
{
    public RatingProgramsController(IMediator mediator, IHttpLanguageProvider languageProvider)
