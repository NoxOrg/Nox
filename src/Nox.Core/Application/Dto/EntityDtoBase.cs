...
{
    public static void ExecuteActionAndCollectValidationExceptions<T>(string propertyName, Func<T> createAction, Dictionary<string, IEnumerable<string>> validationResult)
    {
        try
        {
            createAction();
