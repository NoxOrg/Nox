...
public class SqlStringLocalizer : IStringLocalizer 
{
    ...
    public SqlStringLocalizer(string resourceName, NoxDbContext dbContext)
    {
    ...
    public LocalizedString this[string name]
    {
        get
        {
            ...
            return new LocalizedString(name, text, notSucceed, nameof(NoxDbContext));
        }
    }
    ...
    public IEnumerable<LocalizedString> GetAllStrings(bool includeParentCultures)
    {
        ...
        ).Select(t => new LocalizedString(t.Key, t.Text, false, nameof(NoxDbContext)));
    }
