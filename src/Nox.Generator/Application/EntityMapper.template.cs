...
public class {{className}}: EntityMapperBase<{{entity.Name}}>
{
    ...
    {{- if attribute.Type == "CultureCode" ||  attribute.Type == "MarkDown" ||  attribute.Type == "CountryNumber" || attribute.Type == "Boolean" || attribute.Type == "LatLong" || attribute.Type == "TranslatedText" || attribute.Type == "File" || attribute.Type == "VatNumber" || attribute.Type == "StreetAddress" || attribute.Type == "Money" || attribute.Type == "Text" || attribute.Type == "Number" || attribute.Type == "Area"  || attribute.Type == "TimeZoneCode" || attribute.Type == "Uri" || attribute.Type == "Url" || attribute.Type == "User" || attribute.Type == "Volume" || attribute.Type == "Weight" || attribute.Type == "Yaml" || attribute.Type == "PhoneNumber" || attribute.Type == "Temperature" || attribute.Type == "Percentage" }}
