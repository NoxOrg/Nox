...
internal class EntityLocalizedCreateDtoGenerator : INoxCodeGenerator
{
        ...
        string? projectRootPath)
    {
        ...
        foreach (var entity in codeGeneratorState.Solution.Domain.Entities)
        {
            ...
            new TemplateCodeBuilder(context, codeGeneratorState)
                .WithClassName(NoxCodeGenConventions.GetEntityCreateDtoNameForLocalizedType(entity.Name))
