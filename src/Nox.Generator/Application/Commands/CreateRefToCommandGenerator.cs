...
internal class CreateRefToCommandGenerator : INoxCodeGenerator
{
    ...
    public void Generate(SourceProductionContext context, NoxSolutionCodeGeneratorState codeGeneratorState, GeneratorConfig config)
    {
        ...
        var templateName = @"Application.Commands.CreateRefToCommand";
        foreach (var entity in codeGeneratorState.Solution.Domain.Entities.Where(x => !x.IsOwnedEntity))
        {
            ...
            foreach (var relationship in entity.Relationships)
            {
                ...
                new TemplateCodeBuilder(context, codeGeneratorState)
                    .WithClassName($"CreateRef{entity.Name}To{relatedEntity.Name}Command")
