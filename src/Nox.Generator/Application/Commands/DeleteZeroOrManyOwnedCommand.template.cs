...
internal partial class {{className}}HandlerBase : CommandCollectionBase<{{className}}, {{entity.Name}}Entity>, IRequestHandler <{{className}}, bool>
{
	...
	public virtual async Task<bool> Handle({{className}} request, CancellationToken cancellationToken)
	{
		...
		var entities = parentEntity.{{relationshipName}};
