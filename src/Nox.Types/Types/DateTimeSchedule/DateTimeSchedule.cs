...
public class DateTimeSchedule : ValueObject<string, DateTimeSchedule>
{
    ...
    private readonly Regex _validYear = new(@"^(\*|(?:\*|(?:[1-9][0-9]{3}))\/(?:\d+)|(?:[1-9][0-9]{3})(?:(?:\-(?:[1-9][0-9]{3}))?|(?:\,(?:[1-9][0-9]{3}))*)(?:(?:\/(?:\d+))*)(?:(?:\/(?:[1-9][0-9]{3}))*)((?:\,(?:[1-9][0-9]{3}))*))$", RegexOptions.None, Regex_Default_Timeout_Miliseconds);
