...
public sealed class TimeZoneCode : ValueObject<string, TimeZoneCode>
{
    ...
    private static readonly HashSet<string> TimeZoneCodes = new() { 
            ...
            "CANADA/YUKON", "CET", "CHILE/CONTINENTAL", "CHILE/EASTERISLAND", "CST6CDT", "CUBA", "EET", "EGYPT", "EIRE", 
            "EST", "EST5EDT", "ETC/GMT", "ETC/GMT+0", "ETC/GMT+1", "ETC/GMT+10", "ETC/GMT+11", "ETC/GMT+12", "ETC/GMT+2", 
    ...
    internal override ValidationResult Validate()
    {
        ...
        if (!TimeZoneCodes.Contains(Value))
        {
