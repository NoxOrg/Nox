...
public readonly struct QuantityValue : IFormattable, IEquatable<QuantityValue>, IComparable<QuantityValue>, IComparable
{
    ...
    public static explicit operator long(QuantityValue number)
        => number.Type switch
        {
            ...
            UnderlyingDataType.Double => (long)number._doubleValue,
            _ => throw new NotImplementedException()
        };
    ...
    public static explicit operator int(QuantityValue number)
        => number.Type switch
        {
            ...
            UnderlyingDataType.Double => (int)number._doubleValue,
            _ => throw new NotImplementedException()
        };
    ...
    public static explicit operator short(QuantityValue number)
        => number.Type switch
        {
            ...
            UnderlyingDataType.Double => (short)number._doubleValue,
            _ => throw new NotImplementedException()
        };
    ...
    public static explicit operator byte(QuantityValue number)
        => number.Type switch
        {
            ...
            UnderlyingDataType.Double => (byte)number._doubleValue,
            _ => throw new NotImplementedException()
        };
