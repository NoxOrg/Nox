...
public class DeleteCurrencyByIdCommandHandler: CommandBase<DeleteCurrencyByIdCommand, bool>
{
    ...
    public async override Task<bool> Handle(DeleteCurrencyByIdCommand request, CancellationToken cancellationToken)
    {
