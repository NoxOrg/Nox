        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorField = table.Column<byte[]>(type: "binary(4)", fixedLength: true, maxLength: 4, nullable: false),
                    ...
                    CountryNumberField = table.Column<short>(type: "smallint", nullable: false),
                    ...
                    NumberField = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    VolumeField = table.Column<decimal>(type: "DECIMAL(8,6)", nullable: false),
                    WeightField = table.Column<decimal>(type: "DECIMAL(13,6)", nullable: false),
                    ...
                    DateTimeRangeField_Start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateTimeRangeField_End = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateTimeRangeField_StartTimeZoneOffset = table.Column<TimeSpan>(type: "time", nullable: false),
                    DateTimeRangeField_EndTimeZoneOffset = table.Column<TimeSpan>(type: "time", nullable: false),
                    ...
                    FileField_SizeInBytes = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    ImageField_SizeInBytes = table.Column<long>(type: "bigint", nullable: false),
                    LatLongField_Latitude = table.Column<decimal>(type: "decimal(8,6)", precision: 8, scale: 6, nullable: false),
                    LatLongField_Longitude = table.Column<decimal>(type: "decimal(9,6)", precision: 9, scale: 6, nullable: false),
                    ...
                    StreetAddressField_StreetNumber = table.Column<int>(type: "int", nullable: false),
